...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProviderStatus)(nil), (*hykube.ProviderStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus(a.(*ProviderStatus), b.(*hykube.ProviderStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*hykube.ProviderStatus)(nil), (*ProviderStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus(a.(*hykube.ProviderStatus), b.(*ProviderStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Provider_To_hykube_Provider(in *Provider, out *hykube.Provider, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_hykube_Provider_To_v1alpha1_Provider(in *hykube.Provider, out *Provider, s conversion.Scope) error {
	...
	if err := Convert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus(in *ProviderStatus, out *hykube.ProviderStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus is an autogenerated conversion function.
func Convert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus(in *ProviderStatus, out *hykube.ProviderStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderStatus_To_hykube_ProviderStatus(in, out, s)
}

func autoConvert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus(in *hykube.ProviderStatus, out *ProviderStatus, s conversion.Scope) error {
	return nil
}

// Convert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus is an autogenerated conversion function.
func Convert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus(in *hykube.ProviderStatus, out *ProviderStatus, s conversion.Scope) error {
	return autoConvert_hykube_ProviderStatus_To_v1alpha1_ProviderStatus(in, out, s)
}
