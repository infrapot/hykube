...
// New creates an instance of Hykube admission plugins initializer.
...
func (i pluginInitializer) Initialize(plugin admission.Interface) {
	if wants, ok := plugin.(WantsInternalHykubeInformerFactory); ok {
		wants.SetInternalHykubeInformerFactory(i.informers)
	}
}
