...
replace (
	k8s.io/api v0.28.6 => k8s.io/api v0.0.0-20240725200553-fb1fc3084c0e
	k8s.io/apimachinery v0.28.6 => k8s.io/apimachinery v0.0.0-20240720202316-95b78024e3fe
	k8s.io/client-go v0.28.6 => k8s.io/client-go v0.0.0-20240727175048-71959c526d54
	k8s.io/client-go v10.0.0+incompatible => k8s.io/client-go v0.0.0-20240727175048-71959c526d54
)
...
require (
	...
	// TODO generate own GRPC client to have latest deps
